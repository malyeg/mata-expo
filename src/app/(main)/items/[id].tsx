...
import InactiveItemModal from "@/components/features/items/InactiveItemModal";
import ItemAd from "@/components/features/items/ItemAd";
  ...
  return item ? (
    <>
      <Screen scrollable={true} style={styles.screen}>
        ...
        <View>
          {item?.images && (
            <Carousel data={item.images!} style={styles.carousel} />
          )}
          {showWishIcon && (
            <PressableOpacity
              hitSlop={5}
