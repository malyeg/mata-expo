...
export default {
  app: {
    ...
    intro: {
      ...
      slides: {
        slide1: {
          title: "التجارة القديمة بأسلوب معاصر",
          body: "ماتا تجدد التجارة القديمة في شكل معاصر ولا محدود من المقايضة",
        },
        slide2: {
          title: "لنعيد استخدام الأشياء ونحافظ على موارد الأرض",
          body: "ماتا تدعم البيئة من خلال ترقية مفهوم إعادة التدوير إلى إعادة الاستخدام",
        },
        slide3: {
          title: "يمكنك المتاجرة بالقيمة مقابل القيمة",
          body: "ماتا تروج للتجارة على أساس القيمة مقابل القيمة بدلاً من القيمة مقابل المال",
        },
        slide4: {
          title: "حياة اجتماعية ذات قيمة مضافة",
          body: "ماتا تحفز العلاقات الاجتماعية من خلال صفقات خالية من المال وذات قيمة مضافة",
        },
        slide5: {
          title: "فائدة متبادلة = الكل رابح",
          body: "ماتا تتبنى مفهوم صفقة المقايضة ذات الفائدة المتبادلة حتى يكون الجميع راضين",
        },
      },
    },
  },
  ...
  editProfileScreen: {
    ...
    marketingFlag: {
      ...
      invalid: "حالة غير صالحة",
      tooltip:
        "يرجى الاشتراك لتلقي التحديثات والأخبار حول مجتمع المقايضة على ماتا",
    },
    isPublic: {
